...
public class M16BulletEntity extends AbstractArrow implements ItemSupplier {
	...
	public M16BulletEntity(EntityType<? extends M16BulletEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public M16BulletEntity(EntityType<? extends M16BulletEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static M16BulletEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		M16BulletEntity entityarrow = new M16BulletEntity(AidensTechnologyModEntities.M_16_BULLET.get(), entity, world, null);
	...
	public static M16BulletEntity shoot(LivingEntity entity, LivingEntity target) {
		M16BulletEntity entityarrow = new M16BulletEntity(AidensTechnologyModEntities.M_16_BULLET.get(), entity, entity.level(), null);
