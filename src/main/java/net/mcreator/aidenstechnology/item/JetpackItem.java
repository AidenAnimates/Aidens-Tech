...
public abstract class JetpackItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, new ResourceLocation("item.armor.equip_gold")), () -> Ingredient.of(new ItemStack(AidensTechnologyModItems.STEEL_INGOT.get())),
					List.of(new ArmorMaterial.Layer(new ResourceLocation("aidens_technology:steel"))), 0f, 0f);
			registerHelper.register(new ResourceLocation("aidens_technology:jetpack"), armorMaterial);
	...
	public static class Chestplate extends JetpackItem {
		...
		public ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
			return new ResourceLocation("aidens_technology:textures/entities/texture3.png");
		}
